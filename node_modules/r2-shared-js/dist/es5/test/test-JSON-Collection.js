...
(0, ava_1.default)("JSON SERIALIZE: BelongsTo.Series => Contributor[]", function (t) {
...
(0, ava_1.default)("JSON SERIALIZE: BelongsTo.Series => Contributor[1] collapse-array", function (t) {
    var b = new metadata_belongsto_1.BelongsTo();
...
(0, ava_1.default)("JSON DESERIALIZE: BelongsTo.Series => Contributor[]", function (t) {
    var json = {};
    json.series = [
    ...
    (0, helpers_1.logJSON)(json);
    var b = (0, serializable_1.TaJsonDeserialize)(json, metadata_belongsto_1.BelongsTo);
    (0, helpers_1.inspect)(b);
...
(0, ava_1.default)("JSON DESERIALIZE: BelongsTo.Series => Contributor[1]", function (t) {
    var json = {};
    json.series = [
        { name: contributor1NameStr, identifier: contributor1Id, position: contributor1Pos, role: contributor1RoleArr },
    ];
...
(0, ava_1.default)("JSON DESERIALIZE: BelongsTo.Series => Contributor NAME []", function (t) {
    var json = {};
...
(0, ava_1.default)("JSON DESERIALIZE: BelongsTo.Series => Contributor NAME [1] A", function (t) {
    var json = {};
...
(0, ava_1.default)("JSON DESERIALIZE: BelongsTo.Series => Contributor NAME [1] B", function (t) {
    var json = {};
...
(0, ava_1.default)("JSON DESERIALIZE: BelongsTo.Series => Contributor NAME A", function (t) {
    var json = {};
    json.series = contributor1NameStr;
    (0, helpers_1.logJSON)(json);
    var b = (0, serializable_1.TaJsonDeserialize)(json, metadata_belongsto_1.BelongsTo);
...
(0, ava_1.default)("JSON DESERIALIZE: BelongsTo.Series => Contributor NAME B", function (t) {
    var json = {};
    json.series = contributor2NameObj;
    (0, helpers_1.logJSON)(json);
    var b = (0, serializable_1.TaJsonDeserialize)(json, metadata_belongsto_1.BelongsTo);
