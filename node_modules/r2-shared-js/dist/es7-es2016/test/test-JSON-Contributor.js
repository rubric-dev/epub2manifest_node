...
(0, ava_1.default)("JSON SERIALIZE: Metadata.Imprint => Contributor[]", (t) => {
...
(0, ava_1.default)("JSON SERIALIZE: Metadata.Imprint => Contributor[1] collapse-array", (t) => {
    const b = new metadata_1.Metadata();
...
(0, ava_1.default)("JSON DESERIALIZE: Metadata.Imprint => Contributor[]", (t) => {
    const json = {};
    json.imprint = [
    ...
    (0, helpers_1.logJSON)(json);
    const b = (0, serializable_1.TaJsonDeserialize)(json, metadata_1.Metadata);
    (0, helpers_1.inspect)(b);
...
(0, ava_1.default)("JSON DESERIALIZE: Metadata.Imprint => Contributor[1]", (t) => {
    const json = {};
    json.imprint = [
        { name: contributor1NameStr, identifier: contributor1Id, position: contributor1Pos, role: contributor1RoleArr },
    ];
...
(0, ava_1.default)("JSON DESERIALIZE: Metadata.Imprint => Contributor NAME []", (t) => {
    const json = {};
...
(0, ava_1.default)("JSON DESERIALIZE: Metadata.Imprint => Contributor NAME [1] A", (t) => {
    const json = {};
...
(0, ava_1.default)("JSON DESERIALIZE: Metadata.Imprint => Contributor NAME [1] B", (t) => {
    const json = {};
...
(0, ava_1.default)("JSON DESERIALIZE: Metadata.Imprint => Contributor NAME A", (t) => {
    const json = {};
    json.imprint = contributor1NameStr;
    (0, helpers_1.logJSON)(json);
    const b = (0, serializable_1.TaJsonDeserialize)(json, metadata_1.Metadata);
...
(0, ava_1.default)("JSON DESERIALIZE: Metadata.Imprint => Contributor NAME B", (t) => {
    const json = {};
    json.imprint = contributor2NameObj;
    (0, helpers_1.logJSON)(json);
    const b = (0, serializable_1.TaJsonDeserialize)(json, metadata_1.Metadata);
